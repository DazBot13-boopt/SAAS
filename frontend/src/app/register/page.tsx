        ...
        <div className="min-h-screen bg-[#030303] text-white flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-white/40 font-light">Rejoignez l'élite de l'automatisation</p>
                </div>
                ...
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                    {success ? (
                        ...
                        >
                            ...
                            <p className="text-white/40 text-sm mb-6">Votre compte a été créé avec succès. Un administrateur doit maintenant valider votre accès.</p>
                            <p className="text-violet-400 text-xs animate-pulse">Redirection vers la page de connexion...</p>
                        </motion.div>
                    ) : (
